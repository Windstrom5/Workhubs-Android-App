...
class IzinUserAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        // Bind data to views
        holder.tanggalTextView.text = izin.tanggal.toString()
        holder.alasanTextView.text = izin.kategori

        // Set click listener for the action button
        holder.actionButton.setOnClickListener {
            // Handle button click, e.g., initiate download
            val pdfHtml = getHtmlTemplate(izin, perusahaan, pekerja)
    ...
    private fun getHtmlTemplate(izin: Izin, perusahaan: Perusahaan, pekerja: Pekerja): String {
